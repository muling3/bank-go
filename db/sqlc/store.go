...
func (s *Store) TransferTx(ctx context.Context, arg TransferParams) (TransferTxResult, error) {
	...
	err := s.execTx(ctx, func(q *Queries) error {
		...
		// Updating account balance using transactions APPROACH 1
		...
		// Updating account balance using transactions APPROACH 2
